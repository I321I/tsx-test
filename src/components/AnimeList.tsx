...
export const AnimeListGenerateAnimeItems = (animeSource: string[], setSource: (newSource: string[]) => void) => {
  return animeSource.map((anime, i) =>
...
export const AnimeList = () => {
  ...
  const animeList = AnimeListGenerateAnimeItems(animeSource, setSource)
